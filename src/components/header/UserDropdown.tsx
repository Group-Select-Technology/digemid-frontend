  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm capitalize">{firstName}</span>
        <svg
      ...
      >
        <div>
          ...
          <span className="mt-1 inline-block rounded-full bg-brand-50 px-2 py-0.5 text-xs font-medium text-brand-600 dark:bg-brand-900/30 dark:text-brand-400">
            {user?.role ?? "-"}
          </span>
        </div>
